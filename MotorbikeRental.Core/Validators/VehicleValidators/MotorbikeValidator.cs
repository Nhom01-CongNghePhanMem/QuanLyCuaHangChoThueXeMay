...
namespace MotorbikeRental.Core.Validators.VehicleValidators
{
    public class MotorbikeValidator : IMotorbikeValidator
    {
        ...
        public async Task<bool> ValidateForCreate(MotorbikeViewModel motorbikeViewModel)
        {
        ...
        public async Task<bool> ValidateForUpdate(MotorbikeViewModel motorbikeViewModel)
        {
