...
namespace MotorbikeRental.Infrastructure.Migrations
{
    ...
    [Migration("20250624174616_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MotorbikeRental.Domain.Entities.User.Employee", b =>
                {
                    ...
                    b.HasIndex("UserCredentialId")
                        .IsUnique()
                        .HasFilter("[UserCredentialId] IS NOT NULL");
            ...
            modelBuilder.Entity("MotorbikeRental.Domain.Entities.User.Employee", b =>
                {
                    b.HasOne("MotorbikeRental.Domain.Entities.User.UserCredentials", "UserCredentials")
                        .WithOne("Employee")
                        .HasForeignKey("MotorbikeRental.Domain.Entities.User.Employee", "UserCredentialId")
                        .OnDelete(DeleteBehavior.SetNull);
